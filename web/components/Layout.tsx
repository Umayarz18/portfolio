    ...
    return (
        <div className='overflow-x-hidden'>
            <Head>
                ...
                <meta
                    property='og:url'
                    content={`https://${domain}${router.asPath}`}
                />
                <link
                    rel='canonical'
                    href={`https://${domain}${router.asPath}`}
                />
            ...
            <div
                className={
                    'flex flex-col min-h-screen justify-start items-center w-screen bg-gray-100 bg-gradient-to-r dark:from-gray-900 dark:to-gray-950'
                }
            >
          ...
          lg:px-0 max-w-3xl md:max-w-2xl'
                    >
                        <a
                            href='/'
                            className=' inline-flex items-center max-w-3xl'
                        >
                            <Image
                                src='/Icon.png'
                                height={50}
