...
function VerticalCard({ title, color, description, link, logo, logoStyles }) {
  return (
    <div className="overflow-hidden rounded bg-txt-white shadow-md max-w-sm m-5 content-center grid items-center grid-cols-1 grid-rows-3">
      ...
      <div
        className="px-6  font-bold text-gray-700 text-lg md:text-xl lg:text-2xl mt-3  row-span-1 col-span-3"
        style={{ color: color }}
      >
  ...
  return (
    ...
    >
      <div className="md:flex">
        <div 
            className="md:flex-shrink-0 grid items-center justify-center md:p-3 md:m-2 ">
          <img
