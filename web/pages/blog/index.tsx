    ...
    <Layout title="Blog - Roewyn Umayam" cannonical="blog">
      <div className="max-w-2xl text-gray-600 dark:text-gray-300 m-5">
        <section className="text-gray-600 dark:text-gray-300 font-normal text-lg md:text-xl my-5">
          ...
          >
            I&apos;m trying to document my experiences around software
            development with case studies, tutorials, and notes that might help
            other upcoming developers on your journey. Check back later for some
            posts and in the mean time, you can take a look at some of my{" "}
