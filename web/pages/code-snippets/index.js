    ...
    <Layout title="Code Snippets - Roewyn Umayam" cannonical="code-snippets">
      ...
      >
        <section className="m-5 md:m-0">
          ...
          >
            There's a lot of code I end up reusing or constantly looking up on
            Google on how to do it. To save my time and maybe yours, here's list
            of snippets that might help you out.
          </p>
        </section>
